...
img = rgb2gray(imread('F:/University/2016-2017/CSC420/Assignment/A2/building.jpg'));
...
for si = 1:length(s);
    ...
    imgFilt = conv2(double(imgS),double(H),'same');
    imG(:,:,si) = imgFilt;
    imgFilt2 = conv2(double(imgS),double(Hs),'same');
    %Compute the DoG
